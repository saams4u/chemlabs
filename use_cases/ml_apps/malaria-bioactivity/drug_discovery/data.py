...
from network.AttentiveFP import AttentiveLayers, AttentiveLayers_viz, Featurizer, getFeatures, Featurizer_aromaticity_rm, getFeatures_aromaticity_rm
...
raw_filename = "dataset/malaria-processed.csv"
