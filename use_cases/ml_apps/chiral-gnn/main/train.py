...
for epoch in range(0, args.n_epochs):
    ...
    if val_loss <= best_val_loss:
        ...
        torch.save(model.state_dict(), os.path.join(wandb.run.dir, 'best_model'))
...
# state_dict = torch.load(os.path.join(wandb.run.dir, 'best_model'), map_location=args.device)
